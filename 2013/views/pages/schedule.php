...
<article>
<h1>Schedule</h1>
<p><strong>Dress Code:</strong> Please note that the dress code for the conference is business formal.</p>
<table class="schedule">
	<caption><h2>Friday, February 1</h2></caption>
	<colgroup>
		<col class="time">
		<col class="event">
		<col class="venue">
...
<table class="schedule">
	<caption><h2>Saturday, February 2</h2></caption>
	<colgroup>
		<col class="time">
		<col class="event">
		<col class="venue">
