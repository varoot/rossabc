<?php
set('profile_panel_id', 'transportation');
set('panel_title', 'Transportation');
set('speakers', array('alan-sbarra', 'alan-taub'));
set('moderators', array('jack-hu'));
?>
